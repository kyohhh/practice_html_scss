...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_stylesheet_url(); //使用中テーマのスタイルシートURLを出力 ?>">
...
<body <?php body_class(); //bodyタグにページの種類に応じたクラス名を与える ?>>
    <!-- ヘッダー -->
    <header class="header">
        <img class="header-logo" src="<?php echo get_template_directory_url(); //使用中のテーマURLに置き換わるb?>./image/logo.png" alt="コーディングスクールのロゴ">
